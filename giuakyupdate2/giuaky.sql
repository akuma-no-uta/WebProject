...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2025 at 05:19 PM
...
(6, '123', '213', 'Chưa hoàn thành'),
(7, '213', '213', 'Chưa hoàn thành');
...
(5, '123', '2025-04-20', '321', '321', 'http://localhost/indexAdmin.php?act=tailieuAdmin');
...
INSERT INTO `thongtin` (`id`, `name`, `hero_title`, `hero_subtitle`, `hero_description`, `hero_image_url`, `about_title`, `about_subtitle`, `about_description`, `about_image_url`) VALUES
(1, 'Trang cá nhân của GV. Nguyễn Văn A', 'chaof', 'Giảng viên Khoa Công nghệ Thông tin – Đại học ABC', 'Với hơn 10 năm kinh nghiệm trong lĩnh vực giảng dạy và nghiên cứu CNTT, tôi luôn nỗ lực truyền cảm hứng học tập và sáng tạo cho sinh viên.', '', 'Về tôi', 'Hành trình đào tạo và nghiên cứu', 'Tôi tốt nghiệp Thạc sĩ Công nghệ Thông tin tại Đại học Quốc gia và hiện đang công tác tại Khoa CNTT, Trường Đại học ABC. Lĩnh vực chuyên môn gồm: Lập trình, Mạng máy tính, Bảo mật, và Phát triển phần mềm. Tôi cũng tham gia hướng dẫn nhiều đề tài nghiên cứu khoa học và đồ án sinh viên.', 'https://via.placeholder.com/400x300.png?text=About+GV+CNTT');
